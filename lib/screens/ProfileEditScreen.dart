                        ...
                        Center(
                          ...
                          Row(
                            ...
                            child: ElevatedButton( onPressed: () {
                                ...
                                if (form.validate()) {
                                  Member profile = Member(login: loginController.text, name: nameController.text,
                                  city: cityController.text, age: ageController.text == "" ? 0 : int.parse(ageController.text), pathToAvatar: member.pathToAvatar, sex: sexController.sex);
